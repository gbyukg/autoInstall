...
(function(app) {
    ...
    _templateManager = {
        ...
        setView: function(name, module, src, force) {
            return this._compile(this._getView(name, module, false), src, force);
        },
        ...
        setField: function(type, view, module, src, force) {
            ...
            return this._compile(this._getField(type, view, module, null, true, false), src, force);
        },
        ...
        setLayout: function(name, moduleName, src, force) {
            return this._compile(this._getLayout(name, moduleName, false), src, force);
        },
